        ...
        <div className="menu-bar">
          ...
          <div className="left-icons">
            ...
            <div className="clock-icon">
              {' '}
              <FiClock style={{ fontSize: '17px', color: '#8f8f8f' }} /> 0min
            </div>
            <span className="pipe-separator"></span>
            ...
            <div className="arrow-icon">
              <FiArrowDownLeft style={{ fontSize: '20px', color: '#8f8f8f' }} />
              0
            </div>
          </div>
          {/* Right */}
          <div className="right-icons">
            <div className="check-icon">
              <FiCheckCircle style={{ fontSize: '20px', color: '#8f8f8f' }} />
            </div>
            <div className="cloud-icon">
              <FiCloud style={{ fontSize: '20px', color: '#529d78' }} />
            </div>
            <div className="dots-icon">
              <HiDotsVertical style={{ fontSize: '22px', color: '#000' }} />
            </div>
          </div>
        </div>
